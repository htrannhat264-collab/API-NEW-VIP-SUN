...
app.listen(PORT, () => {
    console.log(`\n============================================================`);
    console.log(`🎲 SUNWIN TX API - PORT ${PORT}`);
    console.log(`============================================================`);
    console.log(`✅ Dữ liệu hiện tại: http://localhost:${PORT}/api/sunwin`);
    console.log(`✅ Lịch sử: http://localhost:${PORT}/api/sunwin/history`);
    console.log(`✅ 84 Models: 21 main + 42 sub + 21 mini`);
    console.log(`============================================================\n`);
});